========================================================================
   APLICACIÓN: JuegosReunidos Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación JuegosReunidos.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación JuegosReunidos.

JuegosReunidos.vcxproj
...
JuegosReunidos.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado JuegosReunidos.pch y un archivo de tipos 
